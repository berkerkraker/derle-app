...
const tr: Dict = {
  ...
  "capture.emptySub": "Önemli işlerin burada görünür. Yukarıya yaz, AI gerisini halleder.",
  "capture.add": "Ekle",
...
const en: Dict = {
  ...
  "capture.emptySub": "Your important items show here. Write above, AI does the rest.",
  "capture.add": "Add",
